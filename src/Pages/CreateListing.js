  ...
  const onSubmit = async (e) => {
    ...
    if (geoLoactionEnable) {
      const response = await fetch(
        `https://maps.googleapis.com/maps/api/geocode/json?address=${address}&key=AIzaSyCsXlLEamCDdbKak4rer-H7oYkemsuMhIU`
      );
    ...
    <Layout>
      <div className="container d-flex flex-column align-items-center justify-content-center mb-4">
        ...
        <form className="w-50 bg-light p-4" onSubmit={onSubmit}>
          <div className="d-flex flex-row mt-4">
            ...
            <div className="form-check ms-3">
              <input
                ...
                id="type"
              />
              <label className="form-check-label" htmlFor="sharing">
                Sharing
              </label>
            </div>
          </div>
          ...
          <div className="mb-3">
            <input
              disabled={!name || !address || !regularPrice || !city || !images}
